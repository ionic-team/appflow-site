...
class AppflowSiteRoutes {
    ...
    render() {
        return (h(Host, null, h(Router.Switch, null, h(Route, { path: "/" }, h("landing-page", null)), h(Route, { path: "/why-appflow" }, h("why-appflow", null)))));
    }
...
const getStartedSectionCss = ".sc-get-started-section-h{display:block;background:#212752;-webkit-padding-before:120px;padding-block-start:120px;-webkit-padding-after:119px;padding-block-end:119px}.ui-container.sc-get-started-section{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-align:end;align-items:flex-end;-ms-flex-pack:justify;justify-content:space-between}.heading-group.sc-get-started-section{-ms-flex-preferred-size:640px;flex-basis:640px}.ui-heading.sc-get-started-section{color:#fff;-webkit-margin-after:7px;margin-block-end:7px}.ui-paragraph.sc-get-started-section{color:var(--c-lavender-50)}.cta.sc-get-started-section{display:-ms-inline-flexbox;display:inline-flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;background:var(--c-lavender-60);color:#fff;padding:14px 16px;border-radius:var(--radius-4);font-size:16px;line-height:112%;font-weight:600;letter-spacing:-0.02em;-webkit-margin-before:var(--space-6);margin-block-start:var(--space-6);-webkit-margin-after:var(--space-2);margin-block-end:var(--space-2)}.cta.sc-get-started-section::after{content:\" ->\";white-space:pre;letter-spacing:0}";
...
const landingPageCss = ".sc-landing-page-h{--p2-color:var(--c-indigo-80);--p3-color:var(--c-indigo-80);--p4-color:var(--c-indigo-80);--poster1-color:#fff;--h1-color:#fff;--h2-color:var(--c-carbon-100);--h4-color:var(--c-carbon-100);--h5-color:var(--c-carbon-100);--h6-color:var(--c-lavender-70);--p2-color:var(--c-indigo-80);--p3-color:var(--c-indigo-80);--p4-color:var(--c-indigo-80)}a.sc-landing-page{color:var(--c-lavender-80)}.ui-heading-2.sc-landing-page{-webkit-margin-after:var(--space-5);margin-block-end:var(--space-5)}.ui-heading-4.sc-landing-page{-webkit-margin-after:var(--space-3);margin-block-end:var(--space-3)}.ui-heading-5.sc-landing-page{-webkit-margin-after:var(--space-3);margin-block-end:var(--space-3)}.ui-heading-6.sc-landing-page{-webkit-margin-after:var(--space-6);margin-block-end:var(--space-6)}@media screen and (min-width: 1200px){.ui-container.sc-landing-page{width:1120px;-webkit-padding-start:0;padding-inline-start:0;-webkit-padding-end:0;padding-inline-end:0}}#top.sc-landing-page{contain:content}#top.sc-landing-page .background.sc-landing-page{width:max(1800px, 100%);position:absolute;left:min(calc((100% - 1800px) / 2), 0px);z-index:-1}#top.sc-landing-page .heading-group.sc-landing-page{-webkit-margin-start:auto;margin-inline-start:auto;-webkit-margin-end:auto;margin-inline-end:auto;max-width:800px;min-height:326px;-webkit-padding-before:var(--space-11);padding-block-start:var(--space-11);-webkit-padding-after:74px;padding-block-end:74px;text-align:center}#top.sc-landing-page .heading-group.sc-landing-page .ui-paragraph.sc-landing-page{-webkit-margin-before:var(--space-5);margin-block-start:var(--space-5);-webkit-margin-after:var(--space-6);margin-block-end:var(--space-6);color:#fff}#top.sc-landing-page .heading-group.sc-landing-page .cta.sc-landing-page{display:-ms-inline-flexbox;display:inline-flex;padding:15px 16px;background:#fff;border-radius:var(--radius-4);-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;font-weight:600;font-size:14px;line-height:112%;letter-spacing:-0.02em}#top.sc-landing-page .heading-group.sc-landing-page .cta.sc-landing-page::after{content:\" ->\";font-size:18px;letter-spacing:0;white-space:pre}#companies.sc-landing-page{-webkit-margin-before:160px;margin-block-start:160px}#companies.sc-landing-page .ui-heading.sc-landing-page{-webkit-margin-after:var(--space-8);margin-block-end:var(--space-8);color:var(--c-indigo-70);text-align:center}#companies.sc-landing-page .logos.sc-landing-page{display:-ms-flexbox;display:flex;-webkit-margin-start:auto;margin-inline-start:auto;-webkit-margin-end:auto;margin-inline-end:auto;-webkit-margin-after:calc(-1 * var(--space-6));margin-block-end:calc(-1 * var(--space-6));-ms-flex-positive:1;flex-grow:1;max-width:1019px;-ms-flex-pack:justify;justify-content:space-between;-ms-flex-align:center;align-items:center;-ms-flex-wrap:wrap;flex-wrap:wrap}#companies.sc-landing-page .logos.sc-landing-page .wrapper.sc-landing-page{display:inline-grid;-webkit-margin-after:var(--space-6);margin-block-end:var(--space-6);-ms-flex-positive:1;flex-grow:1;min-width:400px;grid-template-columns:repeat(auto-fit, minmax(64px, 1fr));row-gap:var(--space-6);justify-items:center;-ms-flex-align:center;align-items:center}@media screen and (max-width: 767px){#companies.sc-landing-page .logos.sc-landing-page .wrapper.sc-landing-page{-ms-flex-preferred-size:400px;flex-basis:400px;min-width:auto}}#companies.sc-landing-page .logos.sc-landing-page .wrapper.sc-landing-page:first-of-type{-ms-flex-positive:1.3333333333;flex-grow:1.3333333333}#ship.sc-landing-page{-webkit-margin-before:160px;margin-block-start:160px;-webkit-margin-after:160px;margin-block-end:160px}#ship.sc-landing-page .heading-group.sc-landing-page{-webkit-margin-start:auto;margin-inline-start:auto;-webkit-margin-end:auto;margin-inline-end:auto;-webkit-margin-after:var(--space-11);margin-block-end:var(--space-11);max-width:736px;text-align:center}#ship.sc-landing-page .list.sc-landing-page{display:-ms-flexbox;display:flex;-ms-flex-preferred-size:352px;flex-basis:352px;-ms-flex-pack:justify;justify-content:space-between;-ms-flex-wrap:wrap;flex-wrap:wrap}#ship.sc-landing-page .list.sc-landing-page .list-item.sc-landing-page{-webkit-margin-start:auto;margin-inline-start:auto;-webkit-margin-end:auto;margin-inline-end:auto;-ms-flex-preferred-size:352px;flex-basis:352px}#push.sc-landing-page{background:var(--c-indigo-0);-webkit-padding-before:160px;padding-block-start:160px;-webkit-padding-after:160px;padding-block-end:160px;contain:content}#push.sc-landing-page .ui-container.sc-landing-page{display:-ms-flexbox;display:flex}#push.sc-landing-page .text.sc-landing-page{max-width:448px}#push.sc-landing-page .text.sc-landing-page .heading-group.sc-landing-page{-webkit-margin-after:72px;margin-block-end:72px}#push.sc-landing-page .list.sc-landing-page{display:grid;grid-template-columns:repeat(auto-fit, minmax(0px, 192px));-webkit-column-gap:var(--space-9);-moz-column-gap:var(--space-9);column-gap:var(--space-9)}#push.sc-landing-page .list.sc-landing-page .list-item.sc-landing-page svg.sc-landing-page{-webkit-margin-after:var(--space-5);margin-block-end:var(--space-5)}#push.sc-landing-page .image.sc-landing-page{display:-ms-flexbox;display:flex;-ms-flex-positive:1;flex-grow:1;-ms-flex-pack:center;justify-content:center}#push.sc-landing-page .image__wrapper.sc-landing-page{display:-ms-flexbox;display:flex;width:auto;position:absolute;left:50%;-ms-flex-direction:column;flex-direction:column}#push.sc-landing-page .image__wrapper.sc-landing-page .icons.sc-landing-page{-webkit-margin-start:var(--space-6);margin-inline-start:var(--space-6)}#push.sc-landing-page .image__wrapper.sc-landing-page .icons.sc-landing-page svg.sc-landing-page+svg.sc-landing-page{-webkit-margin-start:var(--space-5);margin-inline-start:var(--space-5)}#push.sc-landing-page .image__wrapper.sc-landing-page img.sc-landing-page{width:auto;max-width:1092px}#live.sc-landing-page{-webkit-padding-before:160px;padding-block-start:160px;-webkit-padding-after:160px;padding-block-end:160px;contain:content}#live.sc-landing-page .ui-container.sc-landing-page{display:-ms-flexbox;display:flex}#live.sc-landing-page .text.sc-landing-page{max-width:448px}#live.sc-landing-page .list.sc-landing-page{-webkit-margin-before:var(--space-8);margin-block-start:var(--space-8)}#live.sc-landing-page .list.sc-landing-page .list-item.sc-landing-page{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center}#live.sc-landing-page .list.sc-landing-page .list-item.sc-landing-page svg.sc-landing-page{-webkit-margin-end:var(--space-3);margin-inline-end:var(--space-3)}#live.sc-landing-page .list.sc-landing-page .list-item.sc-landing-page+.list-item.sc-landing-page{-webkit-margin-before:var(--space-2);margin-block-start:var(--space-2)}#live.sc-landing-page phone-animator.sc-landing-page{-ms-flex-positive:1;flex-grow:1}#native.sc-landing-page{background:var(--c-indigo-0);-webkit-padding-before:160px;padding-block-start:160px;-webkit-padding-after:160px;padding-block-end:160px}#native.sc-landing-page .ui-container.sc-landing-page{display:-ms-flexbox;display:flex}#native.sc-landing-page .heading-group.sc-landing-page{-webkit-margin-after:72px;margin-block-end:72px}#native.sc-landing-page .heading-group.sc-landing-page .ui-heading.sc-landing-page{max-width:576px}#native.sc-landing-page .heading-group.sc-landing-page .ui-paragraph.sc-landing-page{max-width:448px}#native.sc-landing-page .subtext.sc-landing-page{max-width:256px}#native.sc-landing-page .subtext.sc-landing-page svg.sc-landing-page{-webkit-margin-after:var(--space-5);margin-block-end:var(--space-5)}#native.sc-landing-page .image.sc-landing-page{display:-ms-flexbox;display:flex;-ms-flex-positive:1;flex-grow:1;position:relative;-ms-flex-pack:center;justify-content:center}#native.sc-landing-page .image__wrapper.sc-landing-page{width:auto;position:absolute;top:calc(50% + 150px);right:-150px;left:-250px;-webkit-transform:translateY(-50%);transform:translateY(-50%)}#native.sc-landing-page .image__wrapper.sc-landing-page img.sc-landing-page{max-width:857px}#automate.sc-landing-page{-webkit-padding-before:160px;padding-block-start:160px;-webkit-padding-after:302px;padding-block-end:302px;contain:content}#automate.sc-landing-page .ui-container.sc-landing-page{display:-ms-flexbox;display:flex}#automate.sc-landing-page .heading-group.sc-landing-page .ui-heading.sc-landing-page{max-width:480px}#automate.sc-landing-page .heading-group.sc-landing-page .ui-paragraph.sc-landing-page{max-width:448px}#automate.sc-landing-page .subtext.sc-landing-page{-webkit-margin-start:var(--space-3);margin-inline-start:var(--space-3);-webkit-margin-before:var(--space-8);margin-block-start:var(--space-8);max-width:430px;position:relative}#automate.sc-landing-page .subtext.sc-landing-page::before{content:\" \";background:var(--c-lavender-70);width:2px;height:64px;position:absolute;top:50%;left:-16px;-webkit-transform:translateY(-50%);transform:translateY(-50%)}#automate.sc-landing-page .subtext.sc-landing-page strong.sc-landing-page{font-weight:500;color:var(--c-indigo-100)}#automate.sc-landing-page pipeline-animator.sc-landing-page{-ms-flex-positive:1;flex-grow:1}#managed.sc-landing-page{position:relative;-webkit-padding-before:256px;padding-block-start:256px;-webkit-padding-after:260px;padding-block-end:260px}#managed.sc-landing-page .ui-container.sc-landing-page{display:-ms-flexbox;display:flex}#managed.sc-landing-page .text.sc-landing-page{max-width:448px}#managed.sc-landing-page .image.sc-landing-page{display:-ms-flexbox;display:flex;-ms-flex-positive:1;flex-grow:1;position:relative;-ms-flex-pack:center;justify-content:center}#managed.sc-landing-page .image__wrapper.sc-landing-page{width:auto;position:absolute;top:50%;right:-150px;left:-25px;-webkit-transform:translateY(-50%);transform:translateY(-50%)}#managed.sc-landing-page .image__wrapper.sc-landing-page img.sc-landing-page{max-width:827px}#experience.sc-landing-page{background:var(--c-purple-60);-webkit-padding-before:160px;padding-block-start:160px;-webkit-padding-after:160px;padding-block-end:160px}#experience.sc-landing-page .subtext.sc-landing-page .ui-heading.sc-landing-page{-webkit-margin-after:var(--space-2);margin-block-end:var(--space-2)}#experience.sc-landing-page .subtext.sc-landing-page .ui-paragraph.sc-landing-page{-webkit-margin-after:var(--space-6);margin-block-end:var(--space-6);color:var(--c-lavender-10)}#experience.sc-landing-page .ui-heading.sc-landing-page{color:#fff}#experience.sc-landing-page .cta.sc-landing-page{display:-ms-inline-flexbox;display:inline-flex;padding:14px 16px;background:#8C93FF;color:#fff;border-radius:var(--radius-4);-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;font-weight:600;font-size:14px;line-height:112%;letter-spacing:-0.02em}#experience.sc-landing-page .cta.sc-landing-page::after{content:\" ->\";letter-spacing:0;white-space:pre}#experience.sc-landing-page .list-item.sc-landing-page{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center}#experience.sc-landing-page .list-item.sc-landing-page+.list-item.sc-landing-page{-webkit-margin-before:14px;margin-block-start:14px}#experience.sc-landing-page .list-item.sc-landing-page svg.sc-landing-page{-webkit-margin-end:var(--space-3);margin-inline-end:var(--space-3)}#experience.sc-landing-page .list-item.sc-landing-page .ui-paragraph.sc-landing-page{color:var(--c-lavender-0)}#get-started.sc-landing-page{background:#212752;-webkit-padding-before:120px;padding-block-start:120px;-webkit-padding-after:119px;padding-block-end:119px}#get-started.sc-landing-page .ui-heading.sc-landing-page{-webkit-margin-after:7px;margin-block-end:7px;color:#fff}#get-started.sc-landing-page .ui-paragraph.sc-landing-page{color:var(--c-lavender-50)}#get-started.sc-landing-page .cta.sc-landing-page{display:-ms-inline-flexbox;display:inline-flex;padding:14px 16px;background:var(--c-lavender-60);color:#fff;border-radius:var(--radius-4);-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;font-weight:600;font-size:16px;line-height:112%;letter-spacing:-0.02em}#get-started.sc-landing-page .cta.sc-landing-page::after{content:\" ->\";letter-spacing:0;white-space:pre}";
...
const Automate = () => {
    ...
    return (h("section", { id: "automate" }, h(ResponsiveContainer, null, h("div", null, h("div", { class: "heading-group" }, h(PrismicRichText, { richText: automate, paragraphLevel: 2 })), h("div", { class: "subtext" }, h(PrismicRichText, { richText: automate__subtext, paragraphLevel: 3 }))), h("pipeline-animator", null))));
};
const Managed = () => {
...
const phoneAnimatorCss = ".sc-phone-animator-h{display:inline-block;position:relative}.foreground.sc-phone-animator{position:absolute;width:100%;height:2000px;top:50%;z-index:3;-webkit-transform:translateY(-50%);transform:translateY(-50%)}.background.sc-phone-animator{position:absolute;width:100%;height:2000px;top:50%;z-index:1;-webkit-transform:translateY(-50%);transform:translateY(-50%)}.screen.sc-phone-animator{width:805px;left:95px;position:absolute}.iphone.sc-phone-animator{position:absolute;z-index:2;width:1000px;top:-193px}.iphone.sc-phone-animator .screen.sc-phone-animator{z-index:2;top:218px}";
...
const whyAppflowCss = ".sc-why-appflow-h{--p2-color:var(--c-indigo-80);--p3-color:var(--c-indigo-80);--p4-color:var(--c-indigo-80);--poster1-color:#fff;--h2-color:var(--c-carbon-100);--h4-color:var(--c-carbon-100);--h5-color:var(--c-carbon-100);--h6-color:var(--c-lavender-70);--p2-color:var(--c-indigo-80);--p3-color:var(--c-indigo-80);--p4-color:var(--c-indigo-80)}a.sc-why-appflow{color:var(--c-lavender-80)}.ui-heading-2.sc-why-appflow{-webkit-margin-after:var(--space-5);margin-block-end:var(--space-5)}.ui-heading-4.sc-why-appflow{-webkit-margin-after:var(--space-3);margin-block-end:var(--space-3)}.ui-heading-5.sc-why-appflow{-webkit-margin-after:var(--space-3);margin-block-end:var(--space-3)}.ui-heading-6.sc-why-appflow{-webkit-margin-after:var(--space-6);margin-block-end:var(--space-6)}.ui-paragraph-2.sc-why-appflow{-webkit-margin-before:var(--space-5);margin-block-start:var(--space-5)}@media screen and (min-width: 1200px){.ui-container.sc-why-appflow{width:1120px;-webkit-padding-start:0;padding-inline-start:0;-webkit-padding-end:0;padding-inline-end:0}}#top.sc-why-appflow{background:#212752;-webkit-padding-before:162px;padding-block-start:162px;-webkit-padding-after:162px;padding-block-end:162px;--h6-color:var(--c-lavender-50);--h1-color:#fff;--p2-color:var(--c-lavender-10)}#top.sc-why-appflow .ui-container.sc-why-appflow{display:-ms-flexbox;display:flex;-ms-flex-pack:justify;justify-content:space-between}#top.sc-why-appflow .heading-group.sc-why-appflow{max-width:544px}#top.sc-why-appflow .heading-group.sc-why-appflow .ui-heading-6.sc-why-appflow{-webkit-margin-after:26px;margin-block-end:26px}#top.sc-why-appflow .heading-group.sc-why-appflow .cta.sc-why-appflow{padding:14px 16px;-webkit-margin-before:var(--space-6);margin-block-start:var(--space-6);background:var(--c-lavender-60);color:#fff;border-radius:var(--radius-4);font-weight:600;font-size:14px;line-height:112%;letter-spacing:-0.02em}#top.sc-why-appflow .heading-group.sc-why-appflow .cta.sc-why-appflow::after{content:\" ->\";letter-spacing:0;white-space:pre}#top.sc-why-appflow .image.sc-why-appflow{display:-ms-flexbox;display:flex;-ms-flex-positive:1;flex-grow:1;position:relative;-ms-flex-pack:center;justify-content:center}#top.sc-why-appflow .image.sc-why-appflow img.sc-why-appflow{max-width:457px;position:absolute;top:-30px}#companies.sc-why-appflow{-webkit-padding-before:160px;padding-block-start:160px;-webkit-padding-after:160px;padding-block-end:160px}#companies.sc-why-appflow .row.sc-why-appflow{display:-ms-flexbox;display:flex;-webkit-margin-start:auto;margin-inline-start:auto;-webkit-margin-end:auto;margin-inline-end:auto;-ms-flex-positive:1;flex-grow:1;-ms-flex-pack:distribute;justify-content:space-around;-ms-flex-align:center;align-items:center}#companies.sc-why-appflow .row1.sc-why-appflow{max-width:1018px}#companies.sc-why-appflow .row2.sc-why-appflow{max-width:946px}#companies.sc-why-appflow img.sc-why-appflow{width:auto}#benefits.sc-why-appflow{-webkit-padding-before:160px;padding-block-start:160px;-webkit-padding-after:160px;padding-block-end:160px}#benefits.sc-why-appflow .heading-group.sc-why-appflow{-webkit-margin-after:var(--space-5);margin-block-end:var(--space-5);max-width:640px}#benefits.sc-why-appflow .subtext.sc-why-appflow{-webkit-margin-start:var(--space-3);margin-inline-start:var(--space-3);-webkit-margin-after:var(--space-11);margin-block-end:var(--space-11);max-width:624px;position:relative}#benefits.sc-why-appflow .subtext.sc-why-appflow::before{content:\"\";background:var(--c-lavender-70);width:2px;height:64px;position:absolute;top:50%;left:calc(-1 * var(--space-3));-webkit-transform:translateY(-50%);transform:translateY(-50%)}#integrated.sc-why-appflow{-webkit-padding-before:160px;padding-block-start:160px;-webkit-padding-after:160px;padding-block-end:160px}#integrated.sc-why-appflow img.sc-why-appflow{width:auto}#integrated.sc-why-appflow .heading-group.sc-why-appflow{-webkit-margin-after:var(--space-11);margin-block-end:var(--space-11)}#problems.sc-why-appflow{background:var(--c-indigo-0);-webkit-padding-before:160px;padding-block-start:160px;-webkit-padding-after:160px;padding-block-end:160px}#problems.sc-why-appflow img.sc-why-appflow{width:auto}#problems.sc-why-appflow .heading-group.sc-why-appflow{-webkit-margin-after:var(--space-11);margin-block-end:var(--space-11);max-width:768px}#problems.sc-why-appflow .list-item.sc-why-appflow{display:-ms-flexbox;display:flex;-ms-flex-align:start;align-items:flex-start}#problems.sc-why-appflow .list-item.sc-why-appflow+.list-item.sc-why-appflow{-webkit-margin-before:80px;margin-block-start:80px}#problems.sc-why-appflow .list-item.sc-why-appflow .paragraphs.sc-why-appflow{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column}#problems.sc-why-appflow .list-item.sc-why-appflow .paragraphs.sc-why-appflow .ui-paragraph.sc-why-appflow+.ui-paragraph.sc-why-appflow{-webkit-margin-before:var(--space-5);margin-block-start:var(--space-5)}#different.sc-why-appflow{background:#090C22;-webkit-padding-before:160px;padding-block-start:160px;-webkit-padding-after:160px;padding-block-end:160px;--h6-color:var(--lavender-60);--h2-color:#fff;--h4-color:#fff;--p3-color:var(--c-indigo-30)}#different.sc-why-appflow img.sc-why-appflow{width:auto}#different.sc-why-appflow .heading-group.sc-why-appflow{-webkit-margin-after:var(--space-11);margin-block-end:var(--space-11)}";

class WhyAppflow {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.render = () => (h(Host, null, h("header", null, h("appflow-site-header", null)), h("main", null, h(Top$1, null), h(Companies$1, null), h(Benefits, null), h(Integrated, null), h(Problems, null), h(Different, null), h("get-started-section", null)), h("footer", null, h("appflow-site-footer", null))));
    }
    async componentWillLoad() {
        await getPage('appflow_why_appflow');
    }
    static get assetsDirs() { return ["img-why-appflow"]; }
...
const Top$1 = () => {
    const { top, top__cta } = state.pageData;
    return (h("section", { id: "top" }, h(ResponsiveContainer, null, h("div", { class: "heading-group" }, h(PrismicRichText, { richText: top, paragraphLevel: 2 }), h("a", { class: "cta", href: "#" }, top__cta)), h("div", { class: "image" }, h("img", { src: getAssetPath('./img-why-appflow/top@2x.png'), srcset: `${getAssetPath('./img-why-appflow/top@2x.png')} 2x,
                    ${getAssetPath('./img-why-appflow/top.png')} 1x`, loading: "eager", width: "1024", height: "1328" })))));
};
const Companies$1 = () => {
    const icons = [
        ['bcbs', 128, 24],
    ...
    return (h(ResponsiveContainer, { id: "companies", as: "section" }, h("div", { class: "row row1" }, icons.slice(0, 4).map(item => (h("img", { src: getAssetPath(`./img-why-appflow/logo-${item[0]}@2x.png`), srcset: `${getAssetPath(`./img-why-appflow/logo-${item[0]}.png`)} 1x,
                   ${getAssetPath(`./img-why-appflow/logo-${item[0]}@2x.png`)} 2x`, loading: "lazy", width: item[1], height: item[2] })))), h("div", { class: "row row2" }, icons.slice(4, 8).map(item => (h("img", { src: getAssetPath(`./img-why-appflow/logo-${item[0]}@2x.png`), srcset: `${getAssetPath(`./img-why-appflow/logo-${item[0]}.png`)} 1x,
                   ${getAssetPath(`./img-why-appflow/logo-${item[0]}@2x.png`)} 2x`, loading: "lazy", width: item[1], height: item[2] }))))));
};
const Benefits = () => {
    const { benefits, benefits__subtext, benefits__list } = state.pageData;
    return (h(ResponsiveContainer, { id: "benefits", as: "section" }, h("div", { class: "heading-group" }, h(PrismicRichText, { richText: benefits, paragraphLevel: 2 })), h("div", { class: "subtext" }, h(PrismicRichText, { richText: benefits__subtext })), h(Grid, { class: "list" }, benefits__list.map(({ content }) => (h(Col, { class: "list-item", cols: 4 }, h(PrismicRichText, { richText: content })))))));
};
const Integrated = () => {
    ...
    return (h(ResponsiveContainer, { id: "integrated", as: "section" }, h("div", { class: "heading-group" }, h(PrismicRichText, { richText: integrated })), h(Grid, { class: "list" }, integrated__list.map(({ content }, i) => (h(Col, { class: "list-item", cols: 3 }, h("img", { src: getAssetPath(`./img-why-appflow/icon-${icons[i][0]}@2x.png`), srcset: `${getAssetPath(`./img-why-appflow/icon-${icons[i][0]}.png`)} 1x,
                      ${getAssetPath(`./img-why-appflow/icon-${icons[i][0]}@2x.png`)} 2x`, loading: "lazy", width: icons[i][1], height: icons[i][2] }), h(PrismicRichText, { richText: content })))))));
};
const Problems = () => {
    ...
    return (h("section", { id: "problems" }, h(ResponsiveContainer, null, h("div", { class: "heading-group" }, h(PrismicRichText, { richText: problems })), h("ul", { class: "list" }, problems__list.map(({ content }, i) => (h("li", { class: "list-item" }, h(Grid, null, h(Col, { cols: 1 }, h("img", { src: getAssetPath(`./img-why-appflow/icon-${icons[i][0]}@2x.png`), srcset: `${getAssetPath(`./img-why-appflow/icon-${icons[i][0]}.png`)} 1x,
                            ${getAssetPath(`./img-why-appflow/icon-${icons[i][0]}@2x.png`)} 2x`, loading: "lazy", width: icons[i][1], height: icons[i][2] })), h(Col, { cols: 4 }, h(Heading, { level: content[0].type.slice(-1) }, content[0].text)), h(Col, { cols: 7, class: "paragraphs" }, h(PrismicRichText, { richText: content.slice(1) }))))))))));
};
const Different = () => {
