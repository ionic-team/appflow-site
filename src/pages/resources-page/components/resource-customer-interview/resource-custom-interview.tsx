...
@Component({
  tag: 'resource-custom-interview',
  styleUrl: 'resource-custom-interview.scss',
  scoped: true
})
export class ResourceCustomInterview {
  ...
  render() {
    ...
    return [
      ...
      <div class="resource-article resource-customer-interview">
